...
var Interface = /*#__PURE__*/function () {
  ...
  _createClass(Interface, [{
    ...
    value: function buildBar() {
      ...
      var locale = config.language.current;
      return (0, _redom.el)('div#cconsent-bar.ccb--hidden', (0, _redom.el)("div.ccb__wrapper", (0, _redom.el)('div.ccb__left', (0, _redom.el)('div.cc-text', _Language.default.getTranslation(config, locale, 'barMainText'))), (0, _redom.el)('div.ccb__middle', (0, _redom.el)('a', {
        href: _Language.default.getTranslation(config, locale, 'barLinkLearnMore'),
        target: '_blank',
        rel: 'noopener noreferrer'
      }, _Language.default.getTranslation(config, locale, 'barLinkLearnMoreDesc'))), (0, _redom.el)('div.ccb__right', (0, _redom.el)('div.ccb__button', (0, _redom.el)('a.ccb__edit', _Language.default.getTranslation(config, locale, 'barLinkSetting')), (0, _redom.el)('button.consent-give', _Language.default.getTranslation(config, locale, 'barBtnAcceptAll')), (0, _redom.el)('button.deny-all', _Language.default.getTranslation(config, locale, 'barBtnDenyAll'))))));
    }
  }, {
    key: "buildModal",
    value: function buildModal() {
      ...
      var listCookies = function listCookies(category) {
        ...
        if (list.length) {
          ...
          for (var item in list) {
            listItems.push((0, _redom.el)('li', _Language.default.getTranslation(list[item], config.language.current, 'name')));
          }

          return [(0, _redom.el)('div.ccm__list', (0, _redom.el)('span.ccm__list__title', _Language.default.getTranslation(config, config.language.current, 'modalAffectedSolutions')), (0, _redom.el)('ul', listItems))];
        }
      };

      function makeOnOffFixedElem(key) {
        var offTrasl = _Language.default.getTranslation(config, config.language.current, 'off');

        var onTrasl = _Language.default.getTranslation(config, config.language.current, 'on');

        return (0, _redom.el)('div.ccm__switch-component.disabledon', (0, _redom.el)('div.status-off', offTrasl), (0, _redom.el)('div.ccm__switch-group', (0, _redom.el)('label.ccm__switch', (0, _redom.el)('input.category-onoff', {
          type: 'checkbox',
          'data-category': key,
          'checked': config.categories[key].checked
        }), (0, _redom.el)('span.ccm__switch__slider'))), (0, _redom.el)('div.status-on', onTrasl));
      }
      ...
      function makeOnOffElem(key) {
        ...
        return (0, _redom.el)('div.ccm__switch-component', (0, _redom.el)('div.status-off', offTrasl), (0, _redom.el)('div.ccm__switch-group', (0, _redom.el)('label.ccm__switch', (0, _redom.el)('input.category-onoff', {
          type: 'checkbox',
          'data-category': key,
          'checked': config.categories[key].checked
        }), (0, _redom.el)('span.ccm__switch__slider'))), (0, _redom.el)('div.status-on', onTrasl));
      ...
      function makeIconArrowDown() {
        return (0, _redom.el)(document.createElementNS("http://www.w3.org/2000/svg", "svg"), {
          version: "1.2",
      ...
      function modalTabGroups() {
        ...
        for (var key in config.categories) {
          ...
          contentItems.push((0, _redom.el)('dl.ccm__tabgroup' + '.' + key + (config.categories[key].checked ? '.checked-5jhk' : ''), {
            'data-category': key
          }, (0, _redom.el)('dt.ccm__tab-head', _Language.default.getTranslation(config.categories[key], config.language.current, 'name'), (0, _redom.el)('a.ccm__tab-head__icon-wedge', makeIconArrowDown())), (0, _redom.el)('dd.ccm__tab-content', (0, _redom.el)('div.ccm__tab-content__left', onOffButton), (0, _redom.el)('div.right', (0, _redom.el)('h3', _Language.default.getTranslation(config.categories[key], config.language.current, 'name')), (0, _redom.el)('p', _Language.default.getTranslation(config.categories[key], config.language.current, 'description')), (0, _redom.el)('div.ccm__list', listCookies(key))))));
          i++;
        }
      ...
      return (0, _redom.el)('div#cconsent-modal', (0, _redom.el)('div.ccm__content', (0, _redom.el)('div.ccm__content__heading', (0, _redom.el)('h2', _Language.default.getTranslation(config, config.language.current, 'modalMainTitle')), (0, _redom.el)('p', _Language.default.getTranslation(config, config.language.current, 'modalMainText'), config.modalMainTextMoreLink ? (0, _redom.el)('a', {
        href: config.modalMainTextMoreLink,
        target: '_blank',
        rel: 'noopener noreferrer'
      }, _Language.default.getTranslation(config, config.language.current, 'modalMainTitle')) : null), (0, _redom.el)('div.ccm__cheading__close', '×')), (0, _redom.el)('div.ccm__content__body', (0, _redom.el)('div.ccm__tabs', modalTabGroups())), (0, _redom.el)('div.ccm__footer', (0, _redom.el)('button#ccm__footer__consent-modal-submit', _Language.default.getTranslation(config, config.language.current, 'modalBtnSave')), (0, _redom.el)('button.consent-give', _Language.default.getTranslation(config, config.language.current, 'modalBtnAcceptAll')))));
    }
  }, {
    ...
    value: function addEventListeners(elements) {
      ...
      this.addDenyAllButton(); // If you click Cookie settings and open modal
      ...
      this.elements['modal'].querySelector('.ccm__tabs').addEventListener('click', function (event) {
        ...
        if (event.target.classList.contains('category-onoff')) {
          window.CookieConsent.config.categories[event.target.dataset.category].wanted = window.CookieConsent.config.categories[event.target.dataset.category].checked = event.target.checked === true;
    ...
    key: "addAcceptAllButton",
    value: function addAcceptAllButton() {
      var _this2 = this;
      ...
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          ...
          button.addEventListener('click', function () {
            ...
            _this2.elements['bar'].classList.add('ccb--hidden');
    ...
    key: "addDenyAllButton",
    value: function addDenyAllButton() {
      var _this3 = this;

      // If you click Accept all cookies
      var buttonDenyAll = document.querySelectorAll('.deny-all');

      var _iterator3 = _createForOfIteratorHelper(buttonDenyAll),
          _step3;
